...
**cchatz** is a Ruby on Rails blog application that allows users to send messages to each other that can only be read once.

Submitted by: **Edward Kim**

Time spent: **20** hours

URL: **https://whispering-river-34192.herokuapp.com/**
...
![Video Walkthrough](/cchatz_walkthrough.gif)
